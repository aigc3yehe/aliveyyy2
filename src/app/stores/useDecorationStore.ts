...
interface DecorationState {
  ...
  // Actions
  // fetchDecorations: () => Promise<void>; // Removed
...
export const useDecorationStore = create<DecorationState>((set, get) => {
  ...
  return {
    ...
    setDecoration: <K extends DecorationLayer>(layer: K, variant: DecorationConfig[K]) => {
      const newConfig = {
        ...get().config,
        [layer]: variant,
      };
    ...
    // fetchDecorations removed in favor of useDecorationData hook

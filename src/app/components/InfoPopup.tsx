...
export function InfoPopup({ isOpen, onClose, title, description, position }: InfoPopupProps) {
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          <motion.div
            className="relative z-[91] bg-black border-2 border-[#00ff41] shadow-[0_0_30px_rgba(0,255,65,0.3)] w-full max-w-[280px]"
